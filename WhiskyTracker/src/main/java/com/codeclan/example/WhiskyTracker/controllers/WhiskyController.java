...
public class WhiskyController {
    ...
    public ResponseEntity<List<Whisky>> getAllWhiskies(@RequestParam(value = "distillery", required = false) String distillery, @RequestParam(value = "age", required = false) Integer age){
